(function () {
    ...
    // ========================================================================
    // 7. НАСТРОЙКИ (ДОБАВЛЕНО)
    // ========================================================================
    function addSettings() {
        Lampa.SettingsApi.addParam({
            component: 'server',
            param: {
                name: 'torrserver_preload',
                type: 'trigger',
                default: true
            },
            field: {
                name: Lampa.Lang.translate('settings_server_preload'), // "Использовать буфер пред.загрузки"
                description: Lampa.Lang.translate('settings_server_preload_descr') // "Дожидаться заполнения буфера..."
            },
            onChange: function(value) {
                console.log('Plugin: Preload buffer changed to', value);
                Lampa.Storage.set('torrserver_preload', value);
            }
        });
    }
