    ...
    Lampa.Listener.follow('full', function (e) {
      ...
      if (movie.number_of_seasons) {
        ...
        if (filed && filed.season && filed.episode) {
          ...
          hash = Lampa.Utils.hash([filed.season, filed.season > 10 ? ':' : '', filed.episode, movie.original_name || movie.original_title].join(''));
    ...
    Lampa.Player.play = function (data) {
      ...
      if (data && data.url) {
        ...
        if (data.timeline && data.timeline.hash) {
          ...
          var baseTitle = data.card.number_of_seasons ? data.card.original_name || data.card.original_title : data.card.original_title || data.card.original_name;
          hash = Lampa.Utils.hash([data.season, data.season > 10 ? ':' : '', data.episode, baseTitle].join(''));
          ...
          var cardTitle = data.card.number_of_seasons ? data.card.original_name || data.card.original_title : data.card.original_title || data.card.original_name;
