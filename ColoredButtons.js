...
(function () {
  ...
  function addCustomStyles() {
    ...
    style.textContent = `
      ...
      /* Устанавливаем оптимальный размер иконки reyohoho */

      .full-start__button.view--reyohoho_mod.selector svg {
      ...
      reyohohoButtons.forEach(function (btn) {
        ...
        if (svg) {
          ...
          setTimeout(function() {
            ...
            // Заменяем иконку с уменьшенным размером (38px вместо 64px)
            ...
            if (replaceIconPreservingAttrs(svg, REYOHOHO_SVG_SOURCE, {
              ...
              console.log('✅ Иконка заменена для reyohoho_mod (уменьшенный размер)');
