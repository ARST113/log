...
(function () {
  ...
  function loadOnlineSVG() {
    return _loadOnlineSVG.apply(this, arguments);
  } // Собираем DOM-узел SVG из строки
  function _loadOnlineSVG() {
    _loadOnlineSVG = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch('https://raw.githubusercontent.com/ARST113/Buttons-/refs/heads/main/play-video-svgrepo-com.svg');
          case 3:
            response = _context.sent;
            _context.next = 6;
            return response.text();
          case 6:
            ONLINE_SVG_SOURCE = _context.sent;
          ...
          case 11:
            ...
            console.error('❌ Ошибка загрузки SVG:', _context.t0);
          case 14:
          case "end":
      ...
      if (titleElement) {
        ...
        if (currentText !== lastCheck) {
          ...
          if (currentText === 'Онлайн' && lastActiveButton) {
            ...
            titleElement.textContent = "".concat(pluginName, " - Online");
            console.log("\u2705 \u0417\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A \u0438\u0437\u043C\u0435\u043D\u0451\u043D \u043D\u0430: ".concat(pluginName, " - Online"));
          }
        }
      }
    };
  ...
  function process() {
    ...
    if (ONLINE_SVG_SOURCE) {
      ...
      if (window.Lampa && window.Lampa.Controller && typeof window.Lampa.Controller.collectionSet === 'function') {
        var buttons = document.querySelectorAll('.full-start__button.selector');
  ...
  function observe() {
    var mo = new MutationObserver(function (muts) {
      var _iterator = _createForOfIteratorHelper(muts),
        _step;
      try {
